...
CREATE TABLE "Levels" (
    ...
    CONSTRAINT "Levels_pkey" PRIMARY KEY ("member_id","guild_id")
);
...
-- CreateIndex
CREATE INDEX "Case_guild_id_case_user_id_idx" ON "Case"("guild_id", "case_user_id");

-- CreateIndex
CREATE INDEX "Case_guild_id_case_moderator_id_idx" ON "Case"("guild_id", "case_moderator_id");

-- CreateIndex
CREATE INDEX "Case_guild_id_case_type_idx" ON "Case"("guild_id", "case_type");

-- CreateIndex
CREATE INDEX "Case_case_type_case_expires_at_case_tempban_expired_idx" ON "Case"("case_type", "case_expires_at", "case_tempban_expired");

-- CreateIndex
CREATE INDEX "Case_case_created_at_idx" ON "Case"("case_created_at" DESC);
