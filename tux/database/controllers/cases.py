...
from prisma.types import CaseWhereUniqueInput
...
class CaseController:
    ...
    async def get_cases_by_guild_id_and_target_id_and_moderator_id(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_target_id": case_target_id, "case_moderator_id": case_moderator_id}
        )
    ...
    async def get_cases_by_guild_id_and_target_id_and_reason(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_target_id": case_target_id, "case_reason": case_reason}
        )
    ...
    async def get_cases_by_guild_id_and_target_id_and_expires_at(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_target_id": case_target_id, "case_expires_at": case_expires_at}
        )
    ...
    async def get_cases_by_guild_id_and_moderator_id_and_type(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_moderator_id": case_moderator_id, "case_type": case_type}
        )
    ...
    async def get_cases_by_guild_id_and_moderator_id_and_reason(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_moderator_id": case_moderator_id, "case_reason": case_reason}
        )
    ...
    async def get_cases_by_guild_id_and_moderator_id_and_expires_at(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_moderator_id": case_moderator_id, "case_expires_at": case_expires_at}
        )
    ...
    async def get_cases_by_guild_id_and_reason_and_expires_at(
        ...
        return await self.table.find_many(
            where={"guild_id": guild_id, "case_reason": case_reason, "case_expires_at": case_expires_at}
        )
