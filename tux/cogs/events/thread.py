...
class ThreadEventsCog(commands.Cog, name="Thread Events Handler"):
    ...
    async def on_thread_update(self, before: discord.Thread, after: discord.Thread) -> None:
        logger.info(f"Thread updated: {before} -> {after}")
