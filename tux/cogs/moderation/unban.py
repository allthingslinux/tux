    ...
    async def unban(
        ...
        *,
        ...
        if user not in banned_users:
            await ctx.reply(f"{user} was not found in the guild ban list.", delete_after=30, ephemeral=True)
            return
        ...
        try:
            ...
            await ctx.reply(f"Failed to unban {user}. {e}", delete_after=30, ephemeral=True)
            return
