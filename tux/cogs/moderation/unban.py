...
class Unban(commands.Cog):
    ...
    @app_commands.describe(username_or_id="The username of the member to unban", reason="Reason for unban")
    async def unban(self, interaction: discord.Interaction, username_or_id: str, reason: str | None = None) -> None:
        """
