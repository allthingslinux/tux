...
The GIF Limiter is configured through your server's configuration file. See the [configuration documentation](../../admin/configuration/features.md) for details.
...
See the [admin configuration guide](../../admin/configuration/features.md) for detailed setup instructions and advanced configuration options.
