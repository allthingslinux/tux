"""
Revision ID: cefb1791d3e5
Revises:
Create Date: 2025-11-18 22:35:43.198037+00:00
"""
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("until IS NULL OR until > since", name="check_afk_until_after_since"),
    ...
    with op.batch_alter_table("afk", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_afk_expiring", ["until"], unique=False, postgresql_where="until IS NOT NULL AND perm_afk = FALSE"
        )
    ...
    with op.batch_alter_table("cases", schema=None) as batch_op:
        batch_op.create_index(
            "idx_case_active_guild", ["guild_id"], unique=False, postgresql_where="case_status = TRUE"
        )
    ...
    op.create_table(
        ...
        sa.Column(
            "onboarding_stage",
            sa.Enum(
                "NOT_STARTED", "DISCOVERED", "INITIALIZED", "CONFIGURED", "COMPLETED", name="onboarding_stage_enum"
            ),
            nullable=True,
        ),
        sa.CheckConstraint("audit_log_id IS NULL OR audit_log_id > 0", name="check_audit_log_id_valid"),
        sa.CheckConstraint("dev_log_id IS NULL OR dev_log_id > 0", name="check_dev_log_id_valid"),
        sa.CheckConstraint("id > 0", name="check_guild_config_guild_id_valid"),
        sa.CheckConstraint("jail_channel_id IS NULL OR jail_channel_id > 0", name="check_jail_channel_id_valid"),
        sa.CheckConstraint("jail_role_id IS NULL OR jail_role_id > 0", name="check_jail_role_id_valid"),
        sa.CheckConstraint("join_log_id IS NULL OR join_log_id > 0", name="check_join_log_id_valid"),
        sa.CheckConstraint("length(prefix) > 0", name="check_prefix_not_empty"),
        sa.CheckConstraint("mod_log_id IS NULL OR mod_log_id > 0", name="check_mod_log_id_valid"),
        sa.CheckConstraint("private_log_id IS NULL OR private_log_id > 0", name="check_private_log_id_valid"),
        sa.CheckConstraint("report_log_id IS NULL OR report_log_id > 0", name="check_report_log_id_valid"),
    ...
    with op.batch_alter_table("levels", schema=None) as batch_op:
        batch_op.create_index(
            "idx_levels_active_leaderboard", ["guild_id", "xp"], unique=False, postgresql_where="blacklisted = FALSE"
        )
    ...
    with op.batch_alter_table("permission_commands", schema=None) as batch_op:
        batch_op.create_index("idx_permission_commands_guild", ["guild_id"], unique=False)
        batch_op.create_index("idx_permission_commands_rank", ["required_rank"], unique=False)
    ...
    op.create_table(
        ...
        sa.CheckConstraint("reminder_channel_id > 0", name="check_reminder_channel_id_valid"),
    ...
    with op.batch_alter_table("reminder", schema=None) as batch_op:
        ...
        batch_op.create_index("idx_reminder_guild_sent", ["guild_id", "reminder_sent"], unique=False)
        batch_op.create_index(
            "idx_reminder_pending", ["reminder_expires_at"], unique=False, postgresql_where="reminder_sent = FALSE"
        )
    ...
    op.create_table(
        ...
        sa.CheckConstraint("length(snippet_name) > 0", name="check_snippet_name_not_empty"),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("starboard_channel_id > 0", name="check_starboard_channel_id_valid"),
        sa.CheckConstraint("starboard_threshold >= 1", name="check_starboard_threshold_positive"),
        sa.ForeignKeyConstraint(["id"], ["guild.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.CheckConstraint("message_channel_id > 0", name="check_starboard_msg_channel_id_valid"),
        sa.CheckConstraint("message_guild_id > 0", name="check_starboard_msg_guild_id_valid"),
        sa.CheckConstraint("message_user_id > 0", name="check_starboard_msg_user_id_valid"),
        sa.CheckConstraint("star_count >= 0", name="check_star_count_positive"),
        sa.CheckConstraint("starboard_message_id > 0", name="check_starboard_post_id_valid"),
    ...
    with op.batch_alter_table("starboard_message", schema=None) as batch_op:
        ...
        batch_op.create_index("idx_starboard_msg_guild", ["message_guild_id"], unique=False)
        ...
        batch_op.create_index("ux_starboard_message", ["id", "message_guild_id"], unique=True)
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["guild_id"], ["guild.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["permission_rank_id"], ["permission_ranks.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    with op.batch_alter_table("permission_assignments", schema=None) as batch_op:
        batch_op.create_index("idx_permission_assignments_guild", ["guild_id"], unique=False)
        batch_op.create_index("idx_permission_assignments_rank", ["permission_rank_id"], unique=False)
        batch_op.create_index("idx_permission_assignments_role", ["role_id"], unique=False)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("reminder", schema=None) as batch_op:
        ...
        batch_op.drop_index("idx_reminder_pending", postgresql_where="reminder_sent = FALSE")
    ...
    with op.batch_alter_table("levels", schema=None) as batch_op:
        ...
        batch_op.drop_index("idx_levels_active_leaderboard", postgresql_where="blacklisted = FALSE")

    op.drop_table("levels")
    op.drop_table("guild_config")
    with op.batch_alter_table("cases", schema=None) as batch_op:
        batch_op.drop_index(
            "idx_case_unprocessed_expiring", postgresql_where="case_processed = FALSE AND case_expires_at IS NOT NULL"
        )
        ...
        batch_op.drop_index("idx_case_active_guild", postgresql_where="case_status = TRUE")
    ...
    with op.batch_alter_table("afk", schema=None) as batch_op:
        ...
        batch_op.drop_index("idx_afk_expiring", postgresql_where="until IS NOT NULL AND perm_afk = FALSE")
