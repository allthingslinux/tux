...
from sqlalchemy import BigInteger, Boolean, Column, DateTime, func, select
...
class SoftDeleteMixin(SQLModel):
    ...
    deleted_by: int | None = Field(default=None, sa_column=Column(BigInteger))
...
class AuditMixin(SQLModel):
    ...
    updated_by: int | None = Field(default=None, sa_column=Column(BigInteger))
