...
class TestSchemaErrorHandlingThroughService:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_connection_errors_handled_gracefully(self, disconnected_async_db_service: DatabaseService) -> None:
    ...
    @pytest.mark.integration
    @pytest.mark.asyncio
    async def test_operations_on_disconnected_service(self, disconnected_async_db_service: DatabaseService) -> None:
