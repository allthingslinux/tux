...
from tux.shared.exceptions import TuxDatabaseMigrationError
...
class TestMigrationErrorHandling:
    ...
    async def test_migration_timeout_raises_error(self):
        ...
        with patch.object(setup_service, "_build_alembic_config") as mock_config:
            ...
            with patch("tux.core.setup.database_setup.command.current", side_effect=slow_operation):
    ...
    async def test_database_connection_error_handled(self):
        ...
        with patch.object(db_service, "is_connected", return_value=False):
