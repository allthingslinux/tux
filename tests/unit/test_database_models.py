...
from tux.database.models.models import Guild, GuildConfig, CaseType, Case, PermissionRank
...
# =============================================================================
# TIMESTAMP MIXIN AND AUTOMATIC TIMESTAMP TESTS
# =============================================================================
...
class TestTimestampFunctionality:
    ...
    @pytest.mark.unit
    async def test_timestamp_database_operations(self, db_service: DatabaseService) -> None:
