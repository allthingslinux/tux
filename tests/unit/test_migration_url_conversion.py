...
class TestURLConversion:
    ...
    def test_async_url_conversion_pattern(self):
        ...
        converted = async_url.replace("postgresql+psycopg_async://", "postgresql+psycopg://", 1)
    ...
    def test_sync_url_unchanged(self):
        ...
        converted = sync_url.replace("postgresql+psycopg_async://", "postgresql+psycopg://", 1)
        assert converted == sync_url
    ...
    def test_other_driver_urls_unchanged(self):
        ...
        for url in other_urls:
            converted = url.replace("postgresql+psycopg_async://", "postgresql+psycopg://", 1)
