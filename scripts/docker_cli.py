...
class DockerCLI(BaseCLI):
    ...
    def build(
        self,
        no_cache: Annotated[bool, typer.Option("--no-cache", help="Build without using cache")] = False,
        target: Annotated[str | None, typer.Option("--target", help="Build target stage")] = None,
    ) -> None:
        """Build Docker images."""
    ...
    def down(
        self,
        volumes: Annotated[bool, typer.Option("-v", "--volumes", help="Remove volumes")] = False,
        remove_orphans: Annotated[bool, typer.Option("--remove-orphans", help="Remove orphaned containers")] = False,
    ...
    def logs(
        ...
        tail: Annotated[int | None, typer.Option("-n", "--tail", help="Number of lines to show")] = None,
    ...
    def exec(
        ...
        command: Annotated[list[str] | None, typer.Argument(help="Command to execute")] = None,
    ) -> None:
    ...
    def cleanup(
        self,
        volumes: Annotated[bool, typer.Option("--volumes", help="Include volumes in cleanup")] = False,
    ...
    def test(
        self,
        test_type: Annotated[str, typer.Argument(help="Test type: quick, comprehensive, perf, or security")],
    ) -> None:
        """Run Docker tests."""
    ...
    def _test_build(self, test_result: callable) -> None:
    ...
    def _test_container_startup(self, test_result: callable) -> None:
    ...
    def _test_basic_functionality(self, test_result: callable) -> None:
    ...
    def _test_multi_stage_builds(self, test_result: callable) -> None:
    ...
    def _test_resource_limits(self, test_result: callable) -> None:
    ...
    def _test_network_connectivity(self, test_result: callable) -> None:
    ...
    def _test_filesystem_operations(self, test_result: callable) -> None:
